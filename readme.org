...
More concrete documentation coming soon™.

** Roadmap

Right now, we have /potential/ improvements, but none of these are set in stone.

- adding TS to add better completion for test writers
